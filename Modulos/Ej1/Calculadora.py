...
def Sumar():
    ...
    try:
        if sum1.__contains__(".") or sum2.__contains__("."):
            return print("La Suma es:", Operaciones.Sumar(float(sum1) + float(sum2)))
...
def Restar():
    ...
    try:
        if minuendo.__contains__(".") or sustraendo.__contains__("."):
            return print("La Resta es:", Operaciones.Restar(float(minuendo) + float(sustraendo)))
        return print("La Resta es:", Operaciones.Restar(int(minuendo) + int(sustraendo)))
    except ValueError:
    ...
    try:
        if multiplicando.__contains__(".") or multiplicador.__contains__("."):
            return print("La Multiplicación es:",
                         Operaciones.Multiplicar(float(multiplicando) + float(multiplicador)))
        return print("La Multiplicación es:",
                     Operaciones.Multiplicar(int(multiplicando) + int(multiplicador)))
    except ValueError:
        print("Error: Los valores no son enteros")
        return Calculadora()
...
def Factorial():
    try:
        ...
        print("Error: El valor no son entero")
        return Calculadora()

    print(f"El factorial de {str(factorial)} es: {str(Operaciones.Factorial(factorial))}")
...
def Potencia():
    try:
        ...
        print("Error: Los valores no son enteros", ex.__cause__, ex.args)
        return Calculadora()
    print(f"El valor de  {str(base)} elevado a {str(exponente)} es: {str(Operaciones.Potencia(base, exponente))}")
